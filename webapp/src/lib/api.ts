...
// Always use relative URLs so requests go through the Vite proxy to the backend.
// VITE_BACKEND_URL is only used by non-api helpers that need the absolute URL (e.g. pairing code display).
const API_BASE_URL = "";
